...
<table class="table table-bordered table-secondary table-lg">
        ...
        ?>
     	           				...
     	           				<td> <img class="small-img" src="./uploads/profiles/<?php echo $nomineedata[$i]['photo'] ?>" alt="Group image1"></td>
     	           				<td>
                            ...
                            ?>
     	           		     ...
     	           		     <tr>
     	           		     	...
     	           		     	<td>NOTA</td>
     	           		     	<td><img class="redused-img" src="https://i1.wp.com/factly.in/wp-content/uploads//2017/08/Congress-protesting-use-of-NOTA_factly.jpg?resize=768%2C429&ssl=1" alt="nota"></td>
     	           		     	<td><?php 
                                $SQL="select sum(nota) as total from votes;";
                                $nota_count=mysqli_query($connect,$SQL);
                                if(mysqli_num_rows($nota_count)>0){
                                    $nota_count=mysqli_fetch_all($nota_count,MYSQLI_ASSOC);
                                print_r($nota_count[0]['total']);}
                              ?></td>
     	           		     </tr>
								 <?php
								  }else{
