...
<body>
  ...
  <nav class="sidenav" id="sidenav">
	...
	<div class="navinfo">
		...
		<div class="attrib">
			&copy;Copyright 2023 - Build and Code by Gagan DN,Naman Bafna,Abrar Ashraf <i class="ion ion-md-heart"></i>
		</div>
	</div>
</nav>
<!-- Main -->
                                ...
                                ?>
									...
									<form action="../actions/voteing.php" method="post">
										...
										<?php
											...
											echo '<script>
                                              alert("your voter id is not approved yet");
                                                  </script>';
                            ...
                            ?>
     	           		     ...
     	           		     <tr>
     	           		     	...
     	           		     	<td><form action="../actions/voteing.php" method="post">
										<!--<input type="text" name="notavotes" value=" <?//php echo $data['nota']?>">-->
										<input type="hidden" name="voterid" value=" <?php echo $data['id']?>">
